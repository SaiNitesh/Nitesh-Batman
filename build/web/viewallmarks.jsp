<%-- 
    Document   : viewmarks
    Created on : Jun 20, 2012, 12:01:33 PM
...
<html>
<head><title>VIEW ALL MARKS FORM</title>
...
<form method="GET" name="form"  action="viewallmarks1.jsp" onsubmit="return validate(this)">
<table border=1 align=center width=1182 height=400 bgcolor="" rules="all">
<tr><td>
 <h3 align=center><font color="" face=verdana>VIEW ALL STUDENT MARKS</font> </h3><br>
            
         <table border=0 align=center  bgcolor="">

         <tr><td bgcolor=""><font color="" face="verdana"> ENTER REGULATION:   </font></td> <td bgcolor=""> <input type="text" name="regulation" ></td> </tr>
