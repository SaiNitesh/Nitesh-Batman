...
<form method="GET" name="form"  action="deletestudent1.jsp" onsubmit="return validate(this)">
<table border=1 align=center width="1182" height=400 bgcolor="" rules="all">
<tr><td>
<h3 align=center><font color="" face=verdana size="4"> DELETE STUDENT FROM SEMISTER<small>(Detained Candidates)</small> </font></h3>
<table ALIGN=CENTER border=0 bgcolor="">
 
 
     
 
 <tr align=center><td align=center><font color="" face="verdana">ENTER ID:   </font></td><td> <input type="text" name="id" size="10" ></td></tr>
