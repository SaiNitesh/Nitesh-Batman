...
<body>
<table id="main" width="1182" height="20" border="1" align="center" cellspacing=0 cellpadding=0 bgcolor="">
 <nav id="menu-wrap">    
 <ul id="menu">
...
<table border=1 align=center width=1182 height=100 bgcolor="" rules="all">
<tr><td>
