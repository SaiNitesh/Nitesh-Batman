<%-- 
    ...
    Created on : May 31, 2012, 8:21:11 PM
...
<form method="GET" name="form"  action="viewallstudentsf1.jsp" onsubmit="return validate(this)">
<table border=1 align=center width=1182 height=400 bgcolor="" rules="all">
<tr><td>
        <h3 align=center><font color="" face=verdana>VIEW ALL STUDENTS</font> </h3><br>
                    <center> <font color="" face=verdana> ENTER STUDENT REGULATION: </font> <input type="text" name="regulation"> <br><br>
